...
// fourspuare API *********** API KEY: fsq3z9upl6O5Z4x9RMtx8StpW/AqO55Vuhv3ywRzThir5NI=
async function getFoursquare(business) {
	const options = {
		method: 'GET',
		headers: {
		Accept: 'application/json',
		Authorization: 'fsq3z9upl6O5Z4x9RMtx8StpW/AqO55Vuhv3ywRzThir5NI='
		}
	}
	let limit = 5
